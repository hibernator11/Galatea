...
(function () {
  ...
  describe('Reviews Controller Tests', function () {
    ...
    it('$scope.findOne() should create an array with one review object fetched from XHR using a reviewId URL parameter', inject(function (Reviews) {
      ...
      // Set GET response
      $httpBackend.expectGET(/api\/books\/([0-9a-fA-F]{24})$/).respond(mockReview);
    ...
    describe('$scope.create()', function () {
      ...
      beforeEach(function () {
        ...
        scope.title = 'A Review about MEAN';
    ...
    describe('$scope.remove(review)', function () {
      ...
      it('should send a DELETE request with a valid reviewId and remove the book from the scope', inject(function (Reviews) {
